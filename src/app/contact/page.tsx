        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          ...
          <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200">
            <div className="grid gap-5">
              ...
              <Link href="mailto:skalathmika@gmail.com?subject=Lebra.Ai%20Platform%20Demo%20Request" className="inline-flex items-center justify-center gap-2 rounded-full bg-slate-950 px-7 py-4 text-sm font-bold text-white transition-transform hover:scale-[1.02]">
